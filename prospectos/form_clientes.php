			...
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<div class="form-group">
						...
						<input class="form-control" name="id_vendedores" id="id_vendedores" type="hidden" value="<?= $_COOKIE["id_usuarios"] ?>" >		
						<input class="form-control" type="text" readonly value="<?= $_COOKIE["nombre_usuarios"] ?>" >		
					</div>
